...
import map from '../../../../media/appIcon/map.jpg';
      ...
      <View style={wrapper}>
        ...
        <View style={infoContainer}>
          <View style={rowInfoContainer}>
            ...
            <Text style={infoText}>Đại Học Công Nghệ Thông Tin</Text>
          </View>
          <View style={rowInfoContainer}>
            <Image source={phoneIcon} style={imageStyle} />
            <Text style={infoText}>(+84) 0941863510</Text>
          </View>
          <View style={rowInfoContainer}>
            <Image source={mailIcon} style={imageStyle} />
            <Text style={infoText}>Hứa Phước Thanh</Text>
          </View>
          <View style={[rowInfoContainer, {borderBottomWidth: 0}]}>
            <Image source={messageIcon} style={imageStyle} />
            <Text style={infoText}>17521046@gm.uit.edu.com</Text>
          </View>
        </View>
      </View>
    );
